...
import jp.co.internous.milestone.model.domain.TblCart;
import jp.co.internous.milestone.model.domain.dto.CartDto;
...
public class CartController {
	...
	public String addCart(CartForm f, Model m) {
		...
		TblCart cart = new TblCart(f, userId);
	...
	public boolean deleteCart(@RequestBody String checkedIdList) {
		Map<String, List<Integer>> mCheckedIds = gson.fromJson(checkedIdList, Map.class);
		List<Integer> checkedIds = mCheckedIds.get("checkedIdList");
